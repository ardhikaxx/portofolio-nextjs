            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-xl max-h-[85vh] sm:max-h-[90vh] bg-gray-950/95 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-2xl z-10 text-white overflow-hidden my-auto flex flex-col"
                    ...
                    >
                        ...
                        <button
                            onClick={onClose}
                            className="absolute top-5 right-5 z-30 p-2 rounded-full bg-white/10 hover:bg-white/20 text-gray-300 hover:text-white border border-white/10 transition-all duration-200 cursor-pointer"
                        ...
                        <div className="relative z-10 p-6 sm:p-8 overflow-y-auto max-h-[85vh] sm:max-h-[90vh] text-left space-y-6">
                            {/* Header */}
                            <div>
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-2xl p-4 transition-all hover:border-white/20">
                                <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                                    ...
                                    <button
                                        ...
                                        className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-white/10 hover:bg-white text-white hover:text-black font-mono text-xs font-semibold border border-white/20 transition-all duration-300 shrink-0 cursor-pointer"
                                    >
                                        {copied ? (
                                            <>
                            ...
                            <form onSubmit={handleSendEmail} className="space-y-3 text-left">
                                ...
                                <button
                                    type="submit"
                                    className="w-full flex items-center justify-center gap-2 py-3 px-6 bg-white text-black hover:bg-gray-200 font-mono text-xs sm:text-sm font-bold rounded-xl shadow-lg transition-all duration-300 cursor-pointer"
                                >
